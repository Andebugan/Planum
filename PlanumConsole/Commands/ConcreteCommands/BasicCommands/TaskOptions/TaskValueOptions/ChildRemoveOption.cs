...
namespace Planum.Console.Commands.Task
{
    public class ChildRemoveOption : BaseOption<TaskCommandSettings>
    {
        ...
        public ChildRemoveOption(ILoggerWrapper logger, TaskBufferManager taskBufferManager, OptionInfo optionInfo, ConsoleConfig commandConfig): base(logger, optionInfo, commandConfig)
        {
        ...
        public override bool TryParseValue(ref IEnumerator<string> args, ref List<string> lines, ref TaskCommandSettings result)
        {
            ...
            else
            {
                foreach (var task in result.Tasks)
                    task.Children = task.Children.Except(children).ToHashSet();
            }
