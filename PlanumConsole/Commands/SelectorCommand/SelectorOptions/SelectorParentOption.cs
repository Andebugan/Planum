...
namespace Planum.Console.Commands.Selector
{
    public class SelectorParentOption : SelectorBaseOption
    {
        ...
        public SelectorParentOption(ILoggerWrapper logger, ConsoleConfig commandConfig, OptionInfo optionInfo) : base(logger, commandConfig, optionInfo) { }
            ...
            if (!args.MoveNext())
{
            ...
            {
                lines.Add(ConsoleSpecial.AddStyle($"Unable to parse parent selector option: {args.Current}", foregroundColor: ConsoleInfoColors.Error));
                return false;
            }
