...
namespace Planum.Commands.Selector
{
    public abstract class SelectorBaseOption : IOption<TaskFilter>
    {
        ...
        OptionInfo OptionInfo { get; set; }
        OptionInfo IOption<TaskFilter>.OptionInfo { get => throw new System.NotImplementedException(); set => throw new System.NotImplementedException(); }
        ...
        public bool CheckMatch(string value) => !value.Trim(' ').StartsWith(CommandConfig.CommandPrefix + OptionInfo.Name);
    }
}
